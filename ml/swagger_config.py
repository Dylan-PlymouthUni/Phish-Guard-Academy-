"""
Swagger/OpenAPI configuration for PhishGuard API documentation. 
This module defines a custom OpenAPI schema with detailed descriptions, tags, and security schemes to enhance the API documentation generated by FastAPI.
"""
